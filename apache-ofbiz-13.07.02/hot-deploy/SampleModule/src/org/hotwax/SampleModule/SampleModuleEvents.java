package org.hotwax.SampleModule;
...
public class SampleModuleEvents {
    
    public static final String module = SampleModuleEvents.class.getName();
     
    public static String createSampleModulePersonJavaEvent(HttpServletRequest request, HttpServletResponse response) {
...
//         createPersonContext.put("suffix", suffix);
           ...
           try {
               Map person = dispatcher.runSync("createSampleModulePerson", createPersonCtx);
